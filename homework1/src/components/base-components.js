          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <a className="dropdown-item" href="mailto:nekijt87@gmail.com">
        ...
        <div className="card" style={{ width: "18rem" }}>
          ...
          <div className="card-body">
            <p className="card-text">
              Hi, I’m ZhykharievAnatolii I’m a Frontend developer I’m currently
              learning JavaScript. I like the chosen field of activity and I
              have experience in continuous learning. I study every day, and I
              am happy to learn something new. I'm a disciplined and neat
              person, I happily spend time learning something new. My previous
              work from the very beginning organizes me for continuous
              development, and I am able to quickly remember and use new
    ...
    return (
      <div className="">
        <ul className="nav flex-column">
          ...
          <li className="nav-item">
            <a href="tel:+30634726870" className="btn btn-primary bg-dark">
